...
//      in this case, "this" refers to the object made by the constructor.
// 2. What is "this" when joe.scopeArrow() is invoked?
//     in this case, "this" refers to the window.
// 3. Explain why "this" is different when an arrow function is used.
//      I think it's different because we can't make constructers as an arrow functions, 
//        and "this" doesn't work with prototypes when we use arrow functions. 
